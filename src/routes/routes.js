...
import { DotChartOutlined, RadarChartOutlined, CheckCircleOutlined, HomeOutlined } from '@ant-design/icons';
...
export const mainRoutes = [
  {
    ...
    component: () => <div>Seminarski rad</div>
  },
  {
...
export const renderRoutes = () => {
  return mainRoutes.map((route, index) => <Route exact path={route.path} component={route.component} key={index} />);
};
